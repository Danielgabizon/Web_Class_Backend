 ...
 */
router.post("/:postId", auth_controller_1.default.authTestMiddleware, (req, res) => {
    comments_controller_1.default.addNewItem(req, res);
});
/**
 * @swagger
 * /comments:
 ...
 */
router.get("/", (req, res) => {
    comments_controller_1.default.getAllItems(req, res);
});
/**
 * @swagger
 * /comments/{id}:
...
router.get("/:id", (req, res) => {
    comments_controller_1.default.getItemById(req, res);
});
/**
 * @swagger
 * /comments/{id}:
...
router.put("/:id", auth_controller_1.default.authTestMiddleware, (req, res) => {
    comments_controller_1.default.updateItem(req, res);
});
/**
 * @swagger
 * /comments/{id}:
